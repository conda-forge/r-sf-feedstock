...
# suggested workaround to conda-forge/r-base-feedstock#163
export CXXFLAGS="-DHAVE_WORKING_LOG1P"
export CPPFLAGS="${CPPFLAGS} -DHAVE_WORKING_LOG1P -Wl,-rpath,${PREFIX}/lib"
